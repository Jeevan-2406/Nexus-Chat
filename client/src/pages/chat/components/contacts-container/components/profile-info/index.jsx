        ...
        <div className="flex gap-3 items-center justify-center">
            ...
            <Avatar className="h-12 w-12 rounded-full overflow-hidden">
              {userInfo.image ? (
                ...
                <div className={`uppercase h-12 w-12 text-lg border-[1px] flex items-center justify-center rounded-full ${getColor(userInfo.color)}`}>{userInfo.firstName ? userInfo.firstName.split("").shift() : userInfo.email.split("").shift()}</div>
              )}
            </Avatar>
            </div>
            <div>
