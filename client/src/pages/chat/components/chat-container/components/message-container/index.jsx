...
const MessageContainer = () => {
  ...
  const checkIfImage = (filePath) => {
    const imageRegex = 
    /\.(jpg|jpeg|png|bmp|tiff|tif|webp|svg|ico|heic|heif)$/i;
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:w-[80vw] w-full">
      ...
      {
        showImage && (
          <div className="fixed z-[1000] inset-0 flex items-center justify-center backdrop-blur-lg bg-black/50">
            <div className="relative">
              <img src={`${HOST}/${imageURL}`} className="max-h-[80vh] max-w-full object-contain" />
            </div>
